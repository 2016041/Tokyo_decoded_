...
export const posts = [
  {
    ...
    title_ja: "買わない暮らしが世界の新常識「アンダーコンサンプション・コア」",
    title_en: "Underconsumption Core: Why Buying Less Is the New Global Flex",
    category: "money",
    publishedAt: "2026-06-11",
    thumbnail: "/images/posts/006/006-thumbnail.jpg",
    thumbnailAlt_ja: "シンプルな棚と少ない持ち物",
    thumbnailAlt_en: "Minimal shelf with few curated belongings",
    excerpt_ja: "TikTokで2億回再生超。手持ちで満足する日本古来の知恵が、今世界中でトレンドに。",
    excerpt_en: "With 200M+ TikTok views, the world is embracing Japan's age-old wisdom of mindful, minimal consumption.",
    body: {
      hook:        { ja: "「新しいバッグ買った！」より「このバッグ、5年使ってる」が自慢になる時代、来ちゃいました。アメリカのZ世代が始めた『アンダーコンサンプション・コア』、直訳すると“必要最小限消費”。買い足さず、手持ちを使い切る暮らし方が、TikTokで2億回再生を突破しています。実はこれ、私たち日本人にとっては超身近な感覚なんです。「もったいない」「侘び寂び」――おばあちゃんが教えてくれた価値観が、今や世界の最先端。今日は、この“買わない美学”がなぜ世界中で支持されているのか、そして私たちが日常にどう取り入れられるのか、一緒に見ていきましょう。", en: "\"I bought a new bag!\" is out. \"I've used this bag for five years\" is in. Underconsumption Core, born from American Gen Z on TikTok, has racked up over 200 million views by celebrating the art of buying less and using what you already own. For Japanese readers, this might sound strangely familiar—because it is. The values your grandmother taught you, mottainai (don't waste) and wabi-sabi (beauty in imperfection), are suddenly the most cutting-edge aesthetic on the planet. Today, let's unpack why the world is finally catching up to Japan's quiet wisdom, and how you can weave this trend into your own daily life without feeling like you're missing out." },
      data:        { ja: "数字で見ると、その勢いは本物。TikTokで『#underconsumptioncore』のハッシュタグは2億回以上再生され、関連投稿はこの3ヶ月で前年比約400%増。Instagramでも「使い切りチャレンジ」「ノーバイイヤー（1年間買わない宣言）」が急増中です。背景にあるのは、インフレによる生活費の高騰、過剰消費への疲れ、そして気候変動への不安。コロナ禍で爆発した「リベンジ消費」の反動として、若い世代を中心に“静かな反消費”が広がっているんですね。マッキンゼーの調査でも、Z世代の73%が「環境に配慮したブランドを選ぶ」と回答。買うこと自体がクールじゃなくなってきているのが、今の世界的な空気感です。", en: "The numbers don't lie. The #underconsumptioncore hashtag has surpassed 200 million views on TikTok, with related posts jumping roughly 400% year-over-year in just three months. Instagram is flooded with \"use-it-up challenges\" and \"no-buy year\" pledges. The drivers? Inflation squeezing wallets, consumer fatigue from endless trend cycles, and rising climate anxiety. After the pandemic-era \"revenge spending\" boom, younger consumers are pivoting hard toward quiet anti-consumption. McKinsey reports that 73% of Gen Z prioritize sustainable brands, and a growing share are choosing to skip the purchase entirely. Globally, the act of buying is losing its cool factor—and conscious restraint is taking its place as the ultimate status symbol." },
      explanation: { ja: "アンダーコンサンプション・コアの本質は、「我慢」じゃなくて「満足の再発見」なんです。半分になったリップを最後まで使う、シャンプーボトルを振り切る、3年前のニットを今年も着る――そんな“当たり前の日常”を、あえて美しく見せる。これって、まさに日本の「侘び寂び」の精神。完璧じゃない、使い込まれたものに宿る美しさを愛でる感覚です。さらに「もったいない」という言葉は、2005年にノーベル平和賞受賞者ワンガリ・マータイさんが世界に広めた、日本発の概念。物を大切にする心、足るを知る暮らし。実は私たちが既に持っているこの価値観こそ、世界が今求めているライフスタイルの正解なんですね。", en: "At its core, Underconsumption Core isn't about deprivation—it's about rediscovering satisfaction. Using a lipstick down to the last swipe, finishing the shampoo bottle, wearing the same knit for the third winter: these everyday acts are now framed as quietly aesthetic. Sound familiar? It's essentially wabi-sabi, Japan's centuries-old appreciation for the beauty of worn, imperfect, well-used things. Then there's mottainai, the Japanese concept of honoring resources, which Nobel laureate Wangari Maathai championed globally in 2005. Both philosophies share a core belief: contentment comes from valuing what you have, not chasing what you don't. The world is now scrambling to articulate what Japan has practiced for generations. In other words, the answer the global lifestyle conversation is searching for has been quietly sitting in your obaachan's kitchen drawer all along." },
      practice:    { ja: "じゃあ、明日から何ができる？まずは『使い切り宣言』。今あるコスメ、洗剤、文房具を最後まで使い切るまで新しいものを買わない。次に『30日ルール』。欲しいものを見つけたら、30日待ってみる。8割は「あれ、別にいらないかも」となります。3つ目は『手持ち服コーデチャレンジ』。クローゼットの中身だけで1ヶ月コーデを組む。InstagramやNotionで記録すると楽しいですよ。そして『修理する暮らし』。靴のかかと、洋服のほつれ、家電の不調――捨てる前に直す選択肢を。金継ぎのように、修理跡を“歴史”として愛でる感覚を取り戻しましょう。大事なのは、ストイックにならないこと。楽しみながら続けるのが、長続きの秘訣です。", en: "Ready to try it? Start with a \"Use It Up\" pledge: no new cosmetics, detergents, or stationery until current ones are finished. Next, adopt the 30-Day Rule: when you want something, wait 30 days. Eight times out of ten, the urge vanishes. Third, try a Closet-Only Challenge: build outfits exclusively from what you already own for a month—document it on Instagram or Notion to keep it fun. Fourth, embrace a repair-first mindset. Before tossing scuffed shoes, frayed sweaters, or glitchy gadgets, ask whether they can be mended. Channel the spirit of kintsugi, the Japanese art of repairing pottery with gold, which treats scars as history worth celebrating. The most important rule? Don't be a purist. This isn't about punishment or shame—it's about rediscovering joy in what's already yours. Sustainability sticks when it feels good, not when it feels like a diet." },
      cta:         { ja: "「買わない暮らし」を始めるのに、実はちょっとした道具が役立ちます。手持ちを把握するための在庫管理ノート、修理キット、そして長く使える定番アイテム選びの参考書――こうしたものに少し投資するだけで、結果的に消費は大きく減らせます。Tokyo Decodedでは、ミニマルライフを支える日本のロングライフ商品や、金継ぎキット、サステナブルブランドの特集記事も掲載中。あなたの「もったいない精神」を、世界基準のライフスタイルにアップデートしてみませんか？まずは今日、棚の奥にある“忘れていたお気に入り”を引っ張り出すところから。世界はもう、買わない人をクールだと思い始めています。",  en: "Starting an underconsumption lifestyle is easier with a few smart tools: an inventory notebook to track what you own, a basic repair kit, and a guide to long-lasting essentials worth keeping. A small upfront investment dramatically reduces future spending. Tokyo Decoded regularly features Japan's long-life products, kintsugi repair kits, and sustainable brands rooted in centuries of craft wisdom—perfect companions for this lifestyle shift. Why not upgrade your inherited mottainai instinct into a globally celebrated lifestyle? Start today with the smallest possible step: dig out a forgotten favorite from the back of your shelf and use it this week. The world has officially decided that the people who buy less are the coolest in the room. Japan has known this all along—now it's your turn to lead the conversation."  },
    },
    relatedToolSlug: "",
    affiliateLinks: [],
    tags_ja: ["アンダーコンサンプション", "ミニマリスト", "サステナブル", "もったいない", "侘び寂び"],
    tags_en: ["underconsumption", "minimalism", "sustainability", "mottainai", "wabi-sabi"],
  },
  {
    slug: "006-underconsumption-core-trend",
